...
def instant(analysis=""):
    stri = ""
    assistant = client.beta.assistants.retrieve(assistant_id="asst_Cgrd1nT8aoYjTsEjzKdpmCZh")
    ...
    message = client.beta.threads.messages.create(
        thread_id=thread.id,
        role="user",
        content="provide instant suggestion for the mood analysis :"+analysis
    )
